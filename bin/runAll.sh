...
if [ $delay_enabled -eq 1 ]; then 
       echo " delay Enabled "
       python runSimOneCPU.py  --isDelayConstraint --deadLineFlow1 10  --deadLineFlow2 10   --expectedPdrFlow2 0.6  --expectedPdrFlow1 0.6 --pkPeriod 0.1 --numRuns 10 --enableCellAllocation  --numCycles 200 > temp.log
       sleep 1
